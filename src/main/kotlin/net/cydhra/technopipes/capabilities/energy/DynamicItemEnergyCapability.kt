...
class DynamicItemEnergyCapability(
    currentEnergy: Int = 0, capacity: Int,
    extractionLimit: Int, receivingLimit: Int = -1
) : DynamicEnergyCapability(currentEnergy, capacity, extractionLimit, receivingLimit), IItemCapability {
