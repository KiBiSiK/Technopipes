 ...
 */
open class DynamicEnergyCapability(
    currentEnergy: Int = 0, capacity: Int,
    var extractionLimit: Int, var receivingLimit: Int = -1
) : IEnergyStorage, AbstractComponentCapabilityBridge() {
    ...
    override fun receiveEnergy(maxReceive: Int, simulate: Boolean): Int {
        val totalReceived = min(
            min(this.capacity - this.currentEnergy, maxReceive),
